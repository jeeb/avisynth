...
yuv2rgb_constants_rec709:
						...
						dq	03960000039600000h		; 14688        = ((1-0.2125)*255./112.)<<13+0.5
						dq	0EEF5F930EEF5F930h		; -4363, -1744 = ((K-1)*K/0.7154*255./112.)<<13-0.5, K=(0.2125, 0.0721)
						dq	00000439B0000439Bh		;        17307        = ((1-0.0721)*255./112.)<<13+0.5       
...
yuv2rgb_constants_PC_709:
						...
						dq	0FF000000FF000000h                    
						dq	00000400000004000h		; 16384        = (1.)<<14+0.5                                
						dq	03299000032990000h		; 12953        = ((1-0.2125)*255./127.)<<13+0.5                      
						dq	0F0F8F9FEF0F8F9FEh		; -3848, -1538 = (((K-1)*K/0.7154)*255./127.)<<13-0.5, K=(0.2125, 0.0721)
						dq	000003B9F00003B9Fh		;        15263 = ((1-0.0721)*255./127.)<<13+0.5                      
