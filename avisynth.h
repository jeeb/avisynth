...
struct VideoInfo {
  ...
  int FramesFromAudioSamples(__int64 samples) const { return (HasVideo() && HasAudio()) ? (int)(samples * (__int64)fps_numerator / (__int64)fps_denominator / (__int64)audio_samples_per_second) : 0; }
