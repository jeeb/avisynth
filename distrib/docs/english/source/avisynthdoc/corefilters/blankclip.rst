...
.. describe:: pixel_type 
    ...
    +--------+--------+------------+-------------+------------+--------+
    | **10** | RGBP10 | YUVA444P10 | YUVA422P10  | YUVA420P10 |        |
    +--------+--------+------------+-------------+------------+--------+
    | **12** | RGBP12 | YUVA444P12 | YUVA422P12  | YUVA420P12 |        |
    +--------+--------+------------+-------------+------------+--------+
    | **14** | RGBP14 | YUVA444P14 | YUVA422P14  | YUVA420P14 |        |
    +--------+--------+------------+-------------+------------+--------+
    | **16** | RGB48  | YUVA444P16 | YUVA422P16  | YUVA420P16 |        |
    |        |        |            |             |            |        |
    |        | RGBP16 |            |             |            |        |
    +--------+--------+------------+-------------+------------+--------+
    | **32** | RGBPS  | YUVA444PS  | YUVA422PS   | YUVA420PS  |        |
    +--------+--------+------------+-------------+------------+--------+
    | **Note**: pixel types ``YV411 (YUV411, YUV411P8)`` were omitted  | 
    | from the table.                                                  |
    +--------+--------+------------+-------------+------------+--------+
...
+-----------------+--------------------------------------------------------------+
| AviSynth v2.60  || Added pixel_type="YV24"/"YV16"/"YV411"/"Y8".                |
|                 || Supply useful defaults for new Audio/Video when using a     |
|                 |  Video/Audio only template clip.                             |
+-----------------+--------------------------------------------------------------+
| AviSynth v2.58  | Added ``channels`` and ``sample_type`` parameters.           |
+-----------------+--------------------------------------------------------------+
| AviSynth v2.55  | Added ``color_yuv`` parameter.                               |
+-----------------+--------------------------------------------------------------+
