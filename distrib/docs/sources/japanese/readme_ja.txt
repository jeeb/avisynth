 ...
 説明:
  ...
  これは、AviSynth に同梱されているマニュアルの日本語訳（一部）です。

  現在、私たちはプロジェクトチームを結成して、AviSynth マニュアルの日本語への
  翻訳作業を行っています。しかしながら、すべての翻訳作業が完了するまでには、か
  なりの時間を要することが予想されます。

  このため、月 1 回～ 2 カ月に 1 回程度のペースで、翻訳作業が完了した分のページを公開して行く
  ことにしました。

  まだ数は少ないですが、みなさんのお役に立てれば幸いです。

 ライセンスについて:

   AviSynth マニュアル 日本語版は、クリエイティブ・コモンズ 表示-継承 3.0 ライセンスの下でライセンスされています。
   クリエイティブ・コモンズ 表示-継承 3.0 ライセンスについては、下記の URL を参照してください。

     Creative Commons Attribution-Share Alike 3.0 Unported
     http://creativecommons.org/licenses/by-sa/3.0/

   参考: Avisynth:Copyrights - Avisynth
         http://avisynth.org/mediawiki/Avisynth:Copyrights

 更新履歴:

  - 2008-08-13:
   - 変更: 翻訳のベースを v2.5.8 RC3 に更新。
  - 2008-07-21:
   - 修正: layer.htm
  - 2008-07-18:
  ...
  - 2006-12-01: corefilters の addborders.htm から blur.htm までを収録。
 ...
 連絡先:
  ...
  AviSynth マニュアル 翻訳プロジェクト
  にーやん（niiyan）
  メールアドレス: niiyan@avisynth.info
