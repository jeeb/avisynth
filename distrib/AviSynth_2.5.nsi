...
LangString PlugDir_Text             ${AvsLang} "Impossible d'ιcrire dans le rιpertoire Avisynth Plugin.$\nFermez toutes les applications qui utilisent Avisynth,$\net ensuite rιessayez."
...
LangString StandAlone_Text          ${AvsLang} "Installation des fichiers dans le rιpertoire Product"
LangString Documentation_Text       ${AvsLang} "Documentation"
...
LangString StandAlone_Text          ${AvsLang} "product ƒfƒBƒƒNƒgƒ‚Ιƒtƒ@ƒCƒ‹‚πƒCƒ“ƒXƒg[ƒ‹‚µ‚ά‚·B"
