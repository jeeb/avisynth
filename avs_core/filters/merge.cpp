...
{
    return new MergeChroma(args[0].AsClip(), args[1].AsClip(), args[2].AsFloatf(1.0f), env);
}
...
{
    return new MergeLuma(args[0].AsClip(), args[1].AsClip(), args[2].AsFloatf(1.0f), env);
}
...
{
    return new MergeAll(args[0].AsClip(), args[1].AsClip(), args[2].AsFloatf(0.5f), env);
}
