...
AVSValue __cdecl MinMaxPlane::Create_max_y(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0],user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_Y, MAX, env);}

AVSValue __cdecl MinMaxPlane::Create_min_y(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_Y, MIN, env);}
...
AVSValue __cdecl MinMaxPlane::Create_minmax_y(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_Y, MINMAX_DIFFERENCE, env);}

// U Planes functions

AVSValue __cdecl MinMaxPlane::Create_max_u(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_U, MAX, env);}

AVSValue __cdecl MinMaxPlane::Create_min_u(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_U, MIN, env);}
...
AVSValue __cdecl MinMaxPlane::Create_minmax_u(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_U, MINMAX_DIFFERENCE, env);}
// V Planes functions

AVSValue __cdecl MinMaxPlane::Create_max_v(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_V, MAX, env);}

AVSValue __cdecl MinMaxPlane::Create_min_v(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_V, MIN, env);}
...
AVSValue __cdecl MinMaxPlane::Create_minmax_v(AVSValue args, void* user_data, IScriptEnvironment* env) {
  return MinMax(args[0], user_data, (float)args[1].AsFloat(0.0f), args[2].AsInt(0), PLANAR_V, MINMAX_DIFFERENCE, env);}
