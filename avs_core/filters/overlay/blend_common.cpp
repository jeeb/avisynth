 ...
 ********* Masked Blend ********
 *******************************/
__forceinline static BYTE overlay_blend_c_core(const BYTE p1, const BYTE p2, const int mask) {
 ...
 *******************************************/
__forceinline static BYTE overley_merge_mask_c(const BYTE p1, const int p2) {
  return (p1*p2) >> 8;
}
