...
void convert_yv12_to_yuy2_interlaced_mmx(const BYTE* srcY, const BYTE* srcU, const BYTE* srcV,
...
void convert_yv12_to_yuy2_progressive_mmx(const BYTE* srcY, const BYTE* srcU, const BYTE* srcV,
                    int src_rowsize, int src_pitch, int src_pitch_uv, 
                    BYTE* dst, int dst_pitch,
                    int height) 
{
