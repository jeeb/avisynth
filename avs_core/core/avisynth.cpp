...
void ScriptEnvironment::InitMT()
{
    ...
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AVISource", MtMode::MT_SERIALIZED, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AVIFileSource", MtMode::MT_SERIALIZED, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_WAVSource", MtMode::MT_SERIALIZED, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_OpenDMLSource", MtMode::MT_SERIALIZED, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AVISource", MtMode::MT_SERIALIZED, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ChangeFPS", MtMode::MT_SERIALIZED, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertFPS", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ColorYUV", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_StackVertical", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_StackHorizontal", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Overlay", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToRGB", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToRGB24", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToRGB32", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToY8", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToYV12", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToYV24", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToYV16", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToYV411", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertToYUY2", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ConvertBackToYUY2", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_GeneralConvolution", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_UnalignedSplice", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AlignedSplice", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AudioDub", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Trim", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AudioTrim", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_FreezeFrame", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_DeleteFrame", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_DuplicateFrame", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Reverse", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Loop", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Interleave", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SeparateColumns", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_WeaveColumns", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_WeaveRows", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_DoubleWeave", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SwapFields", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ComplementParity", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AssumeTFF", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AssumeBFF", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AssumeFieldBased", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AssumeFrameBased", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SeparateRows", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Weave", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Pulldown", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SelectEvery", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SelectEven", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SelectOdd", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Bob", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SelectRangeEvery", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Blur", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Sharpen", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_TemporalSoften", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SpatialSoften", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Greyscale", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Grayscale", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Histogram", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Mask", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ColorKeyMask", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ResetMask", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Invert", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ShowAlpha", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ShowRed", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ShowGreen", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ShowBlue", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_MergeRGB", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_MergeARGB", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Layer", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Subtract", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Levels", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_RGBAdjust", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Tweak", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_MaskHS", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Limiter", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Merge", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_MergeChroma", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_MergeLuma", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_FixLuminance", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_FixBrokenChromaUpsampling", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_PeculiarBlend", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SkewRows", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SwapUV", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_UToY", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_VToY", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_UToY8", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_VToY8", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_YToUV", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_PointResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_BilinearResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_BicubicResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_LanczosResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Lanczos4Resize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_BlackmanResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Spline16Resize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Spline36Resize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Spline64Resize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_GaussResize", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_SincResize", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_VerticalReduceBy2", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_HorizontalReduceBy2", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_ReduceBy2", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_FlipVertical", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_FlipHorizontal", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Crop", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_CropBottom", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_AddBorders", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Letterbox", MtMode::MT_NICE_FILTER, false);

    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_TurnLeft", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_TurnRight", MtMode::MT_NICE_FILTER, false);
    this->SetFilterMTMode(BUILTIN_FUNC_PREFIX "_Turn180", MtMode::MT_NICE_FILTER, false);
}
